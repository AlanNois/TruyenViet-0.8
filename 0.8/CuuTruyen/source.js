...
class CuuTruyenParser {
    ...
    getTagSections() {
        ...
        const tags = [
            ...
            { id: 'Đang tiến hành', label: 'dang-tien-hanh' },
            { id: 'Thể thao', label: 'the-thao' },
            { id: 'Hài hước', label: 'hai-huoc' },
            { id: 'Shounen', label: 'shounen' },
            { id: 'Học đường', label: 'hoc-duong' },
            { id: 'Chất lượng cao', label: 'chat-luong-cao' },
            ...
            { id: 'Phiêu lưu', label: 'phieu-luu' },
            { id: 'Hậu tận thế', label: 'hau-tan-the' },
            { id: 'Hành động', label: 'hanh-dong' },
            { id: 'Đã hoàn thành', label: 'da-hoan-thanh' },
            { id: 'Sinh tồn', label: 'sinh-ton' },
            { id: 'Du hành thời gian', label: 'du-hanh-thoi-gian' },
            { id: 'Bí ẩn', label: 'bi-an' },
            { id: 'Trinh thám', label: 'trinh-tham' },
            { id: 'Kinh dị', label: 'kinh-di' },
            { id: 'Manhwa', label: 'manhwa' },
            { id: 'Webtoon', label: 'webtoon' },
            { id: 'Fantasy', label: 'fantasy' },
            { id: 'Võ thuật', label: 'vo-thuat' },
            { id: 'Drama', label: 'drama' },
            { id: 'Hệ thống', label: 'he-thong' },
            { id: 'Lãng mạn', label: 'lang-man' },
            { id: 'Đời thường', label: 'doi-thuong' },
            { id: 'Công sở', label: 'cong-so' },
            { id: 'Sát thủ', label: 'sat-thu' },
            { id: 'Phép thuật', label: 'phep-thuat' },
            { id: 'Tội phạm', label: 'toi-pham' },
            { id: 'Seinen', label: 'seinen' },
            { id: 'Isekai', label: 'isekai' },
            { id: 'Chuyển sinh', label: 'chuyen-sinh' },
            { id: 'Harem', label: 'harem' },
            { id: 'Mecha', label: 'mecha' },
            { id: 'Trung cổ', label: 'trung-co' },
            { id: 'LGBT', label: 'lgbt' },
            { id: 'Yaoi', label: 'yaoi' },
            { id: 'Game', label: 'game' },
            { id: 'Bi kịch', label: 'bi-kich' },
            { id: 'Động vật', label: 'dong-vat' },
            { id: 'Tâm lý', label: 'tam-ly' },
            { id: 'Manhua', label: 'manhua' },
            { id: 'Romance', label: 'romance' },
            { id: 'Shoujo', label: 'shoujo' },
            { id: 'Lịch sử', label: 'lich-su' },
