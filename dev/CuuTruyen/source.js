                ...
                interceptResponse: async (response) => {
                    ...
                    if (response.request.url.includes('drm_data=')) {
                        ...
                        if (drmKey && response.rawData) {
                            const decryptedData = await (0, CuuTruyenDrm_1.unscrambleImage)(new Uint8Array(response.rawData), drmKey);
                            return {
                                ...response,
...
},{"./CuuTruyenDrm":66,"./CuuTruyenParser":67,"./CuuTruyenSetting":68,"@paperback/types":61}],66:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
/**
